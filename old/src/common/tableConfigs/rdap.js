...
export const rdapColumns = (expandedRows) => [
    {
        Header: 'Program',
        accessor: 'program',
        width: 150,
    ...
    },
    {
        ...
        Cell: ({row, toggleRow, copyInfoClipboard}) => {
            ...
            if (row.original.type === 'loading') {
                return (
                    <div className="pl-32 flex align-center">
            ...
            if (row.original.type === 'no-data') {
                return (
                    <div className="pl-32 text-muted">No related data found</div>
                );
            }
                    ...
                    {isOrg && (
                        ...
                        >
                            {row.original.isLoadingRelated ? (
                                <span className="loading-spinner w-16 h-16 border-radius-50 border-blue spin"></span>
                            ) : (
